...
$config['user_expire']                = 60*30;               // How long to remember the user (seconds). Set to zero for no expiration
...
$config['message_start_delimiter'] = '<p><i class="fa fa-info-circle" aria-hidden="true"> '; 	// Message start delimiter
$config['message_end_delimiter']   = '</i></p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p><i class="fa fa-exclamation-triangle" aria-hidden="true"> ';		// Error message start delimiter
$config['error_end_delimiter']     = '</i></p>';	// Error message end delimiter
